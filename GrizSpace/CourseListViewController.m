...
- (void)viewDidLoad
{
    ...
    NSArray *myCourses = [NSArray arrayWithObjects:@"CSCI 491", @"CSCI 576", @"ECON 591", @"ECON 221", nil];
    
    NSArray *myDayTimes = [NSArray arrayWithObjects:@"MWF   8:10-9:00     SS 362", @"MWF  9:10-10:00   SS 355", @"TTh     12:40-2:00      LA 411", @"TTh  3:10-4:30   SS 341",nil];
